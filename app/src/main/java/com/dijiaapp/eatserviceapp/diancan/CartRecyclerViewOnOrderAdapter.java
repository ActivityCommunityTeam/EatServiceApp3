...
public class CartRecyclerViewOnOrderAdapter extends RealmRecyclerViewAdapter<Cart, CartRecyclerViewOnOrderAdapter.MyViewHolder> implements CartRecyclerAdapter {
